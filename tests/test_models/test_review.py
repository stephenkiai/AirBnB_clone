...
- Provides the TestReview class, which contains unit tests for the Review class.
...
class TestReview(unittest.TestCase):
    ...
    Test cases:
    - test_review_attributes: Tests if the Review instance has the required attributes.
    - test_review_inheritance: Tests if the Review instance inherits from BaseModel.
