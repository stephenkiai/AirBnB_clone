...
class TestUser(unittest.TestCase):
    ...
    Test cases:
    - test_user_attributes: Tests if the User instance has the required attributes.
    - test_user_inheritance: Tests if the User instance inherits from BaseModel.
    - test_user_initialization: Tests if the User instance is initialized correctly.
    - test_user_to_dict: Tests if the to_dict method returns the correct dictionary representation.
